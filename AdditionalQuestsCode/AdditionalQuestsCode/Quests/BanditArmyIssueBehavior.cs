    ...
    public class BanditArmyIssueBehavior : CampaignBehaviorBase
    {
        ...
        internal class VillageBanditArmyRaidQuest : QuestBase
        {
            ...
            private void CreateBanditArmyParty()
            {
                ...
                this.BanditArmyMobileParty.InitializeMobilePartyAroundPosition(defaultPartyTemplate, BanditSettlement.GetPosition2D, 0.1f, 0.2f);
                ...
                int num3 = MathF.Ceiling(base.QuestDueTime.RemainingDaysFromNow * foodChange);
                int num4 = num3 / 2;
